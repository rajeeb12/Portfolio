...
function Project({ title, image, description, techstack, previewLink, githubLink }) {
  return (
    <article className="rounded-xl mt-10 overflow-hidden shadow-xl shadow-slate-300 dark:shadow-slate-900 transition duration-300 ease-in-out hover:scale-110">
      <img src={image} alt="" loading="lazy"/>
      <div className="dark:bg-dark-card p-4 cursor-pointer ">
